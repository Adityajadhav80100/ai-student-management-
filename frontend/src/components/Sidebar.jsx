...
export const navConfig = {
  admin: [
    ...
    { label: 'Defaulters', to: '/admin/defaulters', icon: 'warning' },
    { label: 'Create Extra Class', to: '/admin/extra-classes/create', icon: 'event' },
    { label: 'Extra Class List', to: '/admin/extra-classes', icon: 'event_note' },
  ...
  teacher: [
    ...
    { label: 'Extra Classes', to: '/teacher/extra-classes', icon: 'co_present' },
  ],
  student: [
    ...
    { label: 'My Extra Classes', to: '/student/extra-classes', icon: 'event_note' },
